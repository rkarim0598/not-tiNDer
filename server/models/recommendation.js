...
module.exports = class Recommendation {
    ...
    static async findRecommendations({ event_id, user_id }) {
        ...
        let sql = `select users.user_id, users.first_name, users.last_name, users.gender_id, users.biography, users.nickname, users.personality_id, residences.name as residence_name 
        from users 
